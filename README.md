...
1. Sharing a MySQL database for authentication.
2. Using DRF Token Authentication for secured endpoints.
...
2. User Login & Token Issuance (API1):
...
3. Token-Based Authentication (API2):
